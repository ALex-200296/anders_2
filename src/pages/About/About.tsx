  ...
  return (
    <section className={styles.about}>
      ...
      <p>
        ...
        дочерняя маршрутизация, порталы для модального окна. Тесты писал в
        первый раз. Поэтому их немного. Но представление имеется. Спасибо за
        интесив, он научил меня многому.
      </p>
    </section>
  );
};
